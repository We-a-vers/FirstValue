...
const About = () => {
  return (
    <div>
      {/* background */}
      <div className=" bg-gray-5 py-5 px-6">
        <div className="flex flex-col gap-4">
            
            <div className="w-[285px] text-zinc-800 text-lg font-bold font-['Roboto'] uppercase leading-[18px] tracking-[5px]">
                企業願景
            </div>

            <div className="w-[285px] text-justify text-zinc-800 text-[10px] font-normal font-['Inter'] leading-[18px] tracking-widest">
              No.1 is “First Value”“
              <span className="text-slate-300">價值第一</span>
